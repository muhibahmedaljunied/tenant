...
class TransactionSellLine extends Model
{
    ...
    protected $appends = ['main_qty','returned_main_qty'];
    ...
    public function related_variations()
    {
        return $this->belongsTo(\App\Variation::class, 'related_variation_id');
    }
    ...
    public function getMainQtyAttribute()
    {
        if($this->unit_equal_qty){
            return $this->quantity / ($this->unit_equal_qty);
        }
        return $this->quantity;
    }

    public function getReturnedMainQtyAttribute()
    {
        if($this->unit_equal_qty){
            return $this->quantity_returned / ($this->unit_equal_qty);
        }
