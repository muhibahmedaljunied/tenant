...
class EventServiceProvider extends ServiceProvider
{
     ...
     */
    protected $listen = [
        \App\Events\SellTransactionCreated::class => [
            \App\Listeners\SendSellInvoiceToZatcaListener::class,
        ],
        \App\Events\SellReturnTransactionCreated::class => [
            \App\Listeners\SendSellReturnInvoiceToZatcaListener::class,
        ],
