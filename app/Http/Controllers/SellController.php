...
class SellController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $zatcaEnabled = session('business.zatca_phase') === Zatca::STATUS_PHASE2;
        ...
        if (request()->ajax()) {
            ...
            $only_shipments = $this->filter($sells, $sale_type, $is_woocommerce);
    ...
    public function filter($sells, $sale_type, $is_woocommerce)
    {
        ...
        if (!empty(request()->input('payment_status')) && request()->input('payment_status') != 'overdue') {
            ...
            // ->whereRaw("CASE WHEN transactions.pay_term_type = 'days' THEN DATEADD(DAY, transactions.pay_term_number, transactions.transaction_date)WHEN transactions.pay_term_type = 'months' THEN DATEADD(MONTH, transactions.pay_term_number, transactions.transaction_date)END < GETDATE());
        ...
        if (!empty(request()->store_id)) {
            ...
            $sells->where('transactions.store_id', $store_id);
        }
        ...
        return $only_shipments;
    }
    public function get_data_table($sells, $only_shipments, $is_admin, $sale_type, $shipping_statuses, $payment_types, $sales_order_statuses)
    {
            ...
            ->editColumn(
                ...
                function ($sell) {
                    return view('zatca_invoices.datatable.sent_status', [
                        'sent_to_zatca' => $sell->zatca_status
                    ]);
                }
            )
            ->editColumn(
    ...
    public function get_track($isEnabledModuleTracker)
    {
    ...
    public function show(Request $request, $id)
    {
        ...
        $query = Transaction::where('business_id', $business_id)
            ...
            ->with([
                ...
                'sell_lines.related_variations.product_variation',
                'sell_lines.related_variations.unit',
    ...
    public function getDrafts(Request $request)
    {
        ...
        return view('sale_pos.draft')
            ->with(compact('business_locations', 'customers', 'sales_representative', 'menuItems'));
    }
    ...
    public function viewMedia(Request $request, $model_id)
    {
        if (request()->ajax()) {
            ...
            return view('sell.view_media')->with(compact('medias', 'title', 'menuItems'));
        }
    }
}
