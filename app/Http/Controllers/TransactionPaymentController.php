...
class TransactionPaymentController extends Controller
{
    ...
    public function __construct(TransactionUtil $transactionUtil, ModuleUtil $moduleUtil)
    {
        ...
        $this->middleware('can:purchase.payments,sell.payments', ['only' => ['store']]);
    }
    ...
    public function getPayContactDue($contact_id)
    {
        ...
        if (request()->ajax()) {
            ...
            $branchCenters = AcCostCenBranche::forDropdown($business_id);
            $extraCenters = AcCostCenFieldAdd::forDropdown($business_id);

            // $branches = AcCostCenBranche::with('ac_cost_cen_branches')->get();
            // $branchesUsers = AcCostCenBranUser::forDropdown(1101);
