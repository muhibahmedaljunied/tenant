...
class ManageUserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.it_guy.users.index', compact('menuItems'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $menuItems = $request['menuItems'];
        return view("pages.it_guy.users.create", compact('menuItems'));
    }
    ...
    {
        return !empty(System::getProperty('enable_business_based_username')) ? '-' . str_pad(session()->get('business.id'), 2, 0, STR_PAD_LEFT) : null;
    }
