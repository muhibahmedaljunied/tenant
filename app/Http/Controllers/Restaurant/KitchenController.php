...
class KitchenController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (request()->ajax()) {
            $kitchens = kitchen::select('kitchens.name', 'kitchens.id', 'kitchens.printer_id', 'kitchens.description', 'business_locations.name as location')
                ...
                ->when(request('location_id'), fn($q) => $q->where('kitchens.location_id', request('location_id')))
                ->get();



            return view('restaurant.kitchen.datatable.kitchens', compact('menuItems','kitchens'))->render();
        }


        return view('restaurant.kitchen.view', compact('business_locations', 'menuItems'));
    }

    public function index_order(Request $request)
    {
        $business_id = request()->session()->get('user.business_id');
        $orders = $this->restUtil->getKitchenOrders($business_id, ['line_order_status' => 'received'], $request->kitchen);
    ...
    public function create()
    {
        ...
        return view('restaurant.kitchen.create', compact('business_locations', 'printers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('restaurant.kitchen.edit', compact('business_locations', 'kitchen', 'printers'));
    }
    ...
    public function delete($id)
    {
        ...
        $kitchen = kitchen::findOrFail($id)->delete();
        $output = [
            'success' => true,
            'msg' => 'تم حذف المطبخ'
        ];
    ...
    public function products(Request $request)
    {
        ...
        $menuItems = $request->menuItems;
        return view('restaurant.kitchen.products', compact('business_locations', 'kitchen', 'menuItems'));
    }
