...
class AccountReportsController extends Controller
{
    ...
    public function balanceSheet(Request $request)
    {
        ...
        return view('account_reports.balance_sheet', compact('menuItems'));
    }
    ...
    public function trialBalance(Request $request)
    {
     ...
     $menuItems = $request->menuItems;
        return view('account_reports.trial_balance',compact('menuItems'));
    }
    ...
    private function getAccountBalance($business_id, $end_date, $account_type = 'others')
    {
        ...
        return $query->select([
            'name',
            DB::raw("SUM(IIF(AT.type='credit', amount, -1*amount) ) as balance")
        ])
