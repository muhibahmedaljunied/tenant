...
class SellingPriceGroupController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('selling_price_group.index', compact('menuItems'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('selling_price_group.create', ['currencies' => $currencies,'menuItems'=>$menuItems]);
    }
    ...
    public function changecurrency(Request $request)
    {
        ...
        return view('currency.changecurrency', [
