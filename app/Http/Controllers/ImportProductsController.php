...
class ImportProductsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($zip_loaded === false) {
            ...
            return view('import_products.index')->with(compact('menuItems'), 'notification', $output);
        } else {
            return view('import_products.index')->with(compact('menuItems'));
        }
    }
        ...
        try {
            ...
            if ($request->hasFile('products_csv')) {
                ...
                foreach ($imported_data as $key => $value) {
                    ...
                    if (count($value) < self::COLUMNS_COUNT) {
                        $is_valid =  false;
