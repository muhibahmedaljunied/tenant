...
class InvoiceLayoutController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $checkboxes = ['show_business_name','show_patch_number', 'show_location_name', 'show_landmark', 'show_city', 'show_state', 'show_country', 'show_zip_code', 'show_mobile_number', 'show_alternate_number', 'show_email', 'show_tax_1', 'show_tax_2', 'show_logo', 'show_barcode', 'show_payments', 'show_customer', 'show_client_id',
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $checkboxes = ['show_business_name', 'show_location_name', 'show_landmark', 'show_city', 'show_state', 'show_country', 'show_zip_code', 'show_mobile_number', 'show_alternate_number', 'show_email', 'show_tax_1', 'show_tax_2', 'show_logo', 'show_barcode', 'show_payments', 'show_customer', 'show_client_id',
                'show_brand', 'show_sku', 'show_cat_code','show_patch_number', 'show_sale_description', 'show_sales_person', 'show_expiry', 'show_lot', 'show_previous_bal', 'show_image', 'show_reward_point', 'show_qr_code', 'show_commission_agent'];
            foreach ($checkboxes as $name) {
                $input[$name] = !empty($request->input($name)) ? 1 : 0;
            }
    ...
    private function getDesigns() {
        return [
            ...
            'private_design' => __('lang_v1.private_design') . ' (A4)',
            'private_design2' => __('lang_v1.private_design2') . ' (A4)',
            'private_design3' => __('lang_v1.private_design3') . ' (A4)',
            'empty_point_design' => __('lang_v1.point_invoice_design_empty') . ' (A4)',
            'point_design' => __('lang_v1.point_invoice_design') . ' (A4)',
        ];
    }
}
