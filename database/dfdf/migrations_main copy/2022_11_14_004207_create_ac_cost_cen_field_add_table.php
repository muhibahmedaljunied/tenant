...
class CreateAcCostCenFieldAddTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ac_cost_cen_field_add', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ac_cost_cen_field_add');
    }
}
