...
class AddColumnsToAcSettingsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('ac_settings', function (Blueprint $table) {
            ...
            $table->foreign('transactions_inventory')->references('account_number')->on('ac_masters');
            ...
            $table->foreign('beginning_inventory')->references('account_number')->on('ac_masters');
            ...
            $table->foreign('ending_stock_inventory')->references('account_number')->on('ac_masters');
