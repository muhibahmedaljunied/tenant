...
class AddStocktakingInventoryAccountsToAcSettingsTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('ac_settings', function (Blueprint $table) {
            ...
            // -------------------------------------------------- //
            $table->foreign('disability_inventory_id')->references('account_number')->on('ac_masters')->cascadeOnDelete();
            $table->foreign('increase_inventory_id')->references('account_number')->on('ac_masters')->cascadeOnDelete();
            // -------------------------------------------------- //
        });
