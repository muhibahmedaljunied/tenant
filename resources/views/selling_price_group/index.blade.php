...
<section class="content">
    ...
    @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.import_export_selling_price_group_prices')])
        <div class="row">
            <div class="col-sm-6">
                <a href="{{ action('SellingPriceGroupController@export') }}" class="btn btn-primary">
                    @lang('lang_v1.export_selling_price_group_prices')
                </a>
            </div>
            <div class="col-sm-6">
                <form action="{{ action('SellingPriceGroupController@import') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="product_group_prices">@lang('product.file_to_import'):</label>
            ...
            <div class="col-sm-12">
                ...
                <p>&bull; @lang('lang_v1.price_group_import_istruction')</p>
                <p>&bull; @lang('lang_v1.price_group_import_istruction1')</p>
                <p>&bull; @lang('lang_v1.price_group_import_istruction2')</p>
            </div>
        </div>
    @endcomponent
