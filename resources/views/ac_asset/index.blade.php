@extends('layouts.app')
@section('title', __( 'assets.assets'))

@section('content')

<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>@lang( 'assets.assets')
    </h1>
</section>
        ...
        @can('sell.create')
            @slot('tool')
                <div class="box-tools" style="margin-left: 0.5em;">
                    <a class="btn btn-block btn-primary" href="{{action('AcAssetController@create')}}">
                    <i class="fa fa-plus"></i> @lang('assets.add_asset')</a>
                </div>
