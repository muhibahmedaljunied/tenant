@extends('layouts.app')
@section('title', __('chart_of_accounts.add_new_cost_center'))

@section('content')

    <!-- Content Header (Page header) -->
    <section class="content-header">
        <h1>@lang('chart_of_accounts.add_new_cost_center')</h1>
        <!-- <ol class="breadcrumb">
    ...
    <section class="content">
        ...
        @endphp
        <form action="{{ action('AcCostCenBrancheController@store') }}" method="POST" id="cost_center_add_form" class="cost_center_form{{ $form_class }}" enctype="multipart/form-data">
            @csrf
