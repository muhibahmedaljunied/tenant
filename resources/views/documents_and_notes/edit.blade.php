<div class="modal-dialog modal-lg" role="document">
    <form action="{{ action('DocumentAndNoteController@update', $document_note->id) }}" id="docus_notes_form" method="POST">
        @csrf
        @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-12">
                       <div class="form-group">
                            ...
                            <input type="text" name="heading" id="heading" class="form-control" required value="{{ old('heading', $document_note->heading) }}">
                       </div>
                    </div>
                </div>
                <!-- model id like project_id, user_id -->
                <input type="hidden" name="notable_id" value="{{ $document_note->notable_id }}" class="form-control">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="docs_note_description" class="form-control">{{ old('description', $document_note->description) }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
