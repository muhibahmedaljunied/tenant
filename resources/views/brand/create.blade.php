<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <form action="{{ action('BrandController@store') }}" method="POST" id="{{ $quick_add ? 'quick_add_brand_form' : 'brand_add_form' }}">
      @csrf
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <input type="text" name="name" class="form-control" required placeholder="{{ __('brand.brand_name') }}">
        </div>

        <div class="form-group">
          <label for="description">{{ __('brand.short_description') }}:</label>
          <input type="text" name="description" class="form-control" placeholder="{{ __('brand.short_description') }}">
        </div>
