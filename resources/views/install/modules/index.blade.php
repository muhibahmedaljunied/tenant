...
<div class="row">
    <div class="col-md-12 form_col" style="display: none;">
        @component('components.widget')
            <form action="{{ action('\\App\\Http\\Controllers\\Install\\ModulesController@uploadModule') }}" id="upload_module_form" enctype="multipart/form-data" style="display:none" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-5">
