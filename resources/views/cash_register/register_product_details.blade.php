<div class="row" id="product_sold_details">
    <button type="button" class="close no-print" id="close_product_details"
        style="margin-left: 10px;margin-top: 5px;color:red;opacity:0.8;"><span aria-hidden="true">×</span></button>
    <script>
