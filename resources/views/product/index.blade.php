                    ...
                    <div class="col-md-12">
                        @component('components.filters', ['title' => __('report.filters')])
                            ...
                            <div class="col-md-3">
                                <br>
                                <div class="form-group">
                                    <select name="active_state" id="active_state" class="form-control select2"
                                        style="width:100%">
                                        <option value="">{{ __('lang_v1.all') }}</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label
                                        for="product_list_filter_current_stock">{{ __('report.current_stock') . ':' }}</label>
                                    <select name="current_stock" id="product_list_filter_current_stock"
        ...
        @endif --}}
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control " id="default_selling_price"
                                            name="default_selling_price" value="">
                                        <span class="input-group-btn">
                                            <button type="button" class="btn btn-default bg-white btn-flat btn-modal"
                                                title="@lang('unit.add_unit')"><i
                                                    class="fa fa-search text-primary fa-lg"></i></button>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <br>
                                    <label>
                                        <input type="checkbox" name="not_for_selling" id="not_for_selling"
                                            class="input-icheck" value="1"> <strong>@lang('lang_v1.not_for_selling')</strong>
                                    </label>
                                </div>
                            </div>
...
@section('javascript')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('change',
                '#default_selling_price,#product_list_filter_image,#product_list_filter_current_stock,#product_list_filter_current_stock,#product_list_filter_type, #product_list_filter_category_id, #product_list_filter_brand_id, #product_list_filter_unit_id, #product_list_filter_tax_id,\
                             #location_id,#store_id, #active_state, #repair_model_id',
                function() {
            ...
            if ($(e.target).attr('href') == '#product_stock_report') {
                if (!data_table_initailized) {
                    ...
                    if ($('th.stock_price').length) {
                        ...
                        stock_report_cols.push({
                            data: 'stock_price_curr',
                            name: 'stock_price_curr',
                            searchable: false
                        });
                        stock_report_cols.push({
                        ...
                        stock_report_cols.push({
                            data: 'stock_value_by_sale_price_curr',
                            name: 'stock_value_by_sale_price_curr',
                            searchable: false,
                            orderable: false
                        });
                        stock_report_cols.push({
                    ...
                    stock_report_table = $('#stock_report_table').DataTable({
                        ...
                        ajax: {
                            ...
                            data: function(d) {
                                ...
                                d.unit_id = $('#unit').val();
                                d.only_mfg_products = $('#only_mfg_products').length && $(
                                    '#only_mfg_products').is(':checked') ? 1 : 0;
                            },
                        },
                        ...
                        fnDrawCallback: function(oSettings) {
                            ...
                            var total_stock_price_curr = sum_table_col($('#stock_report_table'),
                            ...
                            var footer_stock_value_by_sale_price_curr = sum_table_col($(
                                '#stock_report_table'), 'footer_stock_value_by_sale_price_curr');
        ...
        $(document).on('click', '.update_product_location', function(e) {
            ...
            if (selected_rows.length > 0) {
                ...
                swal('@lang('product.product_type')');
            }
        });
