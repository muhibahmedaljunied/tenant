    ...
    <div class="col-sm-8 col-sm-offset-2">
        <div class="form-group">
            <div class="input-group">
                ...
                <input type="text" name="search_product" class="form-control mousetrap" id="search_product" placeholder="{{ __('lang_v1.search_product_placeholder') }}">
            </div>
        </div>
    </div>
    <div class="col-sm-12">
        ...
        <div class="col-sm-12 col-sm-offset-4">
            <div class="col-sm-4">
                ...
                <input type="text" name="profit_percent" value="{{ @num_format($profit_percent) }}" class="form-control input-sm input_number mousetrap" id="margin">
            </div>
            <div class="col-sm-4">
                <label for="selling_price">{{ __('product.default_selling_price') }}:</label>
                <input type="text" name="selling_price" value="{{ @num_format(0) }}" class="form-control input-sm input_number mousetrap" id="selling_price">

                <input type="hidden" name="selling_price_inc_tax" value="{{ @num_format(0) }}" class="input_number mousetrap" id="selling_price_inc_tax">
            </div>
        </div>
    </div>
</div>
