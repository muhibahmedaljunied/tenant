...
<div class="input-group">
    ...
    <input type="text" 
        name="products[{{ $product->id }}][variations][{{ $variation->id }}][default_purchase_price]" 
...
<div class="input-group">
    ...
    <input type="text" 
        name="products[{{ $product->id }}][variations][{{ $variation->id }}][dpp_inc_tax]" 
...
<td>
    <input type="text" 
        name="products[{{ $product->id }}][variations][{{ $variation->id }}][profit_percent]" 
...
<td>
    <div class="input-group">
        <span class="input-group-addon"><small>@lang('product.exc_of_tax')</small></span>
        <input type="text" 
            name="products[{{ $product->id }}][variations][{{ $variation->id }}][default_sell_price]" 
    ...
    <div class="input-group">
        <span class="input-group-addon"><small>@lang('product.inc_of_tax')</small></span>
        <input type="text" 
            name="products[{{ $product->id }}][variations][{{ $variation->id }}][sell_price_inc_tax]" 
...
<td style="text-align: left;">
    @foreach($price_groups as $k => $v)
        ...
        <div class="input-group" style="width: 100%;">
            ...
            <input type="text" 
                name="products[{{ $product->id }}][variations][{{ $variation->id }}][group_prices][{{ $k }}]" 
                value="{{ !empty($price_grp) ? @num_format($price_grp->price_inc_tax) : 0 }}" 
