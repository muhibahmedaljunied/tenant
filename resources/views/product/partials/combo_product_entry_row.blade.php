...
@foreach($variations as $variation)
    <tr>
        ...
        <td class="text-center">
            <input type="text" name="quantity[]" value="{{ @num_format($quantity) }}" class="form-control col-sm-12 input-sm quantity input_number mousetrap" required style="width: 77px;">
