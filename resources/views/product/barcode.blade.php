            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="barcode_type" id="barcode_type" class="form-control" required>
                          @foreach($barcode_types as $key => $label)
                            <option value="{{$key}}" @if($barcode_default == $key) selected @endif>{{$label}}</option>
                          @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    @if($product->type=='variable')
                        <div class="form-group">
                            <label for="variation">{{ __('product.product_type') . ':' }}</label>
                            <select name="variation" id="variation" class="form-control select2" style="width:100%">
