    ...
    @component('components.filters', ['title' => __('report.filters')])
        <div class="col-md-3">
            <div class="form-group">
                <label for="product_list_filter_type">{{ __('product.product_type') . ':' }}</label>
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label for="product_list_filter_unit_id">{{ __('product.unit') . ':' }}</label>
        ...
        <div class="col-md-3">
         ...
         <div class="col-md-3">
            <div class="form-group">
                ...
                <select name="type" id="product_list_filter_image" class="form-control select2" style="width:100%">
                    <option value="">{{ __('lang_v1.all') }}</option>
        ...
        <div class="col-md-3">
          <div class="form-group">
            <br>
            <label>
              <input type="checkbox" name="not_for_selling" id="not_for_selling" class="input-icheck" value="1"> <strong>@lang('lang_v1.not_for_selling')</strong>
            </label>
          </div>
        </div>
        @if($is_woocommerce)
            <div class="col-md-3">
                <div class="form-group">
                    <br>
                    <label>
                      <input type="checkbox" name="woocommerce_enabled" id="woocommerce_enabled" class="input-icheck" value="1"> {{ __('lang_v1.woocommerce_enabled') }}
                    </label>
                </div>
            </div>
        @endif
