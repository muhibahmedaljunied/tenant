            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        {!! Form::text('sku2', $product->sku2, ['class' => 'form-control', 'placeholder' => __('product.sku2')]) !!}
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    ...
                    <label>
                        {!! Form::checkbox('enable_multi_unit', 0, old('enable_multi_unit', $product->multi_unit_active), [
                            'class' => 'input-icheck',
                            'id' => 'enable_multi_unit',
        ...
        function getTemplate(number) {
            return ` <tr>
                      <td>
                          <br>
                        <div class="input-group width-100">
                          {!! Form::select('another_unit[${number}][unit_id]', $units, '', [
                              'class' => 'form-control select2 width-100 unit_id',
                              'required',
                          ]) !!}
                      </div>
                      </td>
                      <td>
                          ...
                          <input type="text" class="form-control input-sm input_number" name="another_unit[${number}][qty]" required value="0" >
                      </td>
                      <td>
                          <div class="col-sm-6">
                            {!! Form::label('single_dpp', trans('product.exc_of_tax') . ':*') !!}
                            {!! Form::text('another_unit[${number}][single_dpp]', 0, [
                          ...
                          <br>
                            ...
                            {!! Form::text('another_unit[${number}][single_dpp_inc_tax]', 0, [
                      ...
                      <td>
                          <div class="col-sm-6">
                              {!! Form::label('single_dpp', trans('product.exc_of_tax') . ':*') !!}
                              {!! Form::text('another_unit[${number}][single_dsp]', 0, [
                          ...
                          {!! Form::label('single_dpp_inc_tax', trans('product.inc_of_tax') . ':*') !!}
                          {!! Form::text('another_unit[${number}][single_dsp_inc_tax]', 0, [
                              'class' => 'form-control input-sm  input_number',
                              'placeholder' => __('product.inc_of_tax'),
