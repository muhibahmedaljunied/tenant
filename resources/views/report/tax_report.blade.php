                ...
                @component('components.filters', ['title' => __('report.filters')])
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="tax_report_location_id" id="tax_report_location_id" class="form-control select2"
                                style="width:100%">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="tax_report_date_range" id="tax_report_date_range" class="form-control"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="info-box info-box-new-style">
                                                ...
                                                <div class="info-box-content">
                                                    <span class="info-box-text"
                                                        style="color:#3ebfbe">{{ __('home.total_sell') }}</span>
                                                    <table>
                                                        <tr>
                                                            <td><span class="total-labels">الاجمالي غير شامل الضريبه : </span>
                                                            </td>
                                                            <td><span class="info-box-number total_sell"><i
                                                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td></span><span class="total-labels">الاجمالي شامل الضريبه :
                                                                </span></td>
                                                            <td><span class="info-box-number total_sell_inc_tax"><i
                                                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td></span><span class="total-labels">الضريبه : </span></td>
                                                            <td><span class="info-box-number total_tax_sell"><i
                                                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i>
                                                            </td>
                                                        </tr>
                                                    </table>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 col-custom">
                                            <div class="info-box info-box-new-style">
                                                ...
                                                <div class="info-box-content">
                                                    <span class="info-box-text"
                                                        style="color:#2d91ea">{{ __('home.total_purchase') }}</span>
                                                    <table>
                                                        <tr>
                                                            <td><span class="total-labels">الاجمالي غير شامل الضريبه : </span>
                                                            </td>
                                                            <td><span class="info-box-number total_purchase"><i
                                                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i>
                                                                </span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td><span class="info-box-number total_purchase_inc_tax"><i
                                                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td></span><span class="total-labels">الضريبه : </span></td>
                                                            <td><span class="info-box-number total_tax_purchase"><i
                                                                        class="fas fa-sync fa-spin fa-fw margin-bottom"></i>
                                                            </td>
                                                        </tr>
                                                    </table>
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li>
                            <a href="#output_tax_tab" data-toggle="tab" aria-expanded="true"><i
                                    class="fa fas fa-arrow-circle-up" aria-hidden="true"></i>
                                @lang('report.output_tax')</a>
                        </li>

                        <li>
                            <a href="#expense_tax_tab" data-toggle="tab" aria-expanded="true"><i
                                    class="fa fas fa-minus-circle" aria-hidden="true"></i>
                                @lang('lang_v1.expense_tax')</a>
                        </li>
                            ...
                            <table class="table table-bordered table-striped" id="input_tax_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('lang_v1.total_without_taxes')</th>
                                        <th>@lang('lang_v1.total_with_taxes')</th>
                                ...
                                <tfoot>
                                    <tr class="bg-gray font-17 text-center footer-total">
                                        ...
                                        <td colspan="2"><span class="display_currency" id="sell_total"
                            ...
                            <table class="table table-bordered table-striped" id="expense_tax_table" width="100%">
                                ...
                                <tfoot>
                                    <tr class="bg-gray font-17 text-center footer-total">
                                        ...
                                        <td><span class="display_currency" id="expense_total"
                                                data-currency_symbol="true"></span></td> @foreach ($taxes as $tax)
                                        <td>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="#input_tax_tab" data-toggle="tab" aria-expanded="true">
                                    <i class="fa fas fa-arrow-circle-down" aria-hidden="true"></i>
                                    @lang('report.input_tax')
                                </a>
                            </li>

                            <li>
                                <a href="#output_tax_tab" data-toggle="tab" aria-expanded="true">
                            ...
                            <li>
                                <a href="#expense_tax_tab" data-toggle="tab" aria-expanded="true">
                                    <i class="fa fas fa-minus-circle" aria-hidden="true"></i>
                                    @lang('lang_v1.expense_tax')
                                </a>
                            </li>
