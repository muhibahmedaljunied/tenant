        ...
        <div class="col-md-12">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select name="tax_report_location_id" id="tax_report_location_id" class="form-control select2" style="width:100%">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="tax_report_date_range" id="tax_report_date_range" class="form-control" placeholder="{{ __('lang_v1.select_a_date_range') }}" readonly>
                </div>
            </div>
            @endcomponent
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 col-custom">
                                    <div class="info-box info-box-new-style">
                                        ...
                                        <div class="info-box-content">
                                            <span class="info-box-text" style="color:#3ebfbe">{{ __('home.total_sell')
                                                }}</span>
                                            <table>
                                                <tr>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12 col-custom">
                                    <div class="info-box info-box-new-style">
                                        ...
                                        <div class="info-box-content">
                                            <span class="info-box-text" style="color:#2d91ea">{{
    ...
    $(document).ready(function() {
        ...
        input_tax_table = $('#input_tax_table').DataTable({
            ...
            columns: [
                ...
                { data: 'total_after_tax', name: 'total_after_tax',searchable: false, orderable: false  },
