    ...
    <div class="modal-body">
      ...
      <div class="col-md-6">
        <div class="form-group">
          <label for="exp_date_expiry_modal">{{ __( 'product.exp_date' ) . ':*' }}</label>
          <input type="text" name="exp_date" id="exp_date_expiry_modal" class="form-control" value="{{ @format_date($purchase_line->exp_date) }}" required readonly>
