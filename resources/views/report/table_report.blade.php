...
<section class="content">
    ...
    <div class="form-group">
        ...
        <select id="tr_location_id" name="tr_location_id" class="form-control select2" style="width:100%">
...
<div class="col-md-3">
    <div class="form-group">
        ...
        <input type="text" id="tr_date_range" name="date_range" value="{{ @format_date('first day of this month') }} ~ {{ @format_date('last day of this month') }}" class="form-control" placeholder="{{ __('lang_v1.select_a_date_range') }}" readonly>
    </div>
</div>
