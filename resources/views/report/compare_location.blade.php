              ...
              <form id="stock_report_filter_form" method="get" action="{{ action('ReportController@compare_locations') }}">
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="location1">{{ __('purchase.business_location') . ':' }}</label>
                        <select name="location_id" id="location1" class="form-control select2" style="width:100%">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="location2">{{ __('purchase.business_location') . '2:' }}</label>
                        <select name="location_id2" id="location2" class="form-control select2" style="width:100%">
                            @foreach($business_locations as $key => $value)
                                <option value="{{ $key }}">{{ $value }}</option>
                            @endforeach
                        </select>
