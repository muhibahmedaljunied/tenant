...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            ...
            <form method="GET" action="{{ action('ReportController@getStockReport') }}" id="product_purchase_report_form">
                @csrf
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="search_product" id="search_product" class="form-control" placeholder="@lang('lang_v1.search_product_placeholder')" autofocus>
                        </div>
                    </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="product_pr_date_filter">@lang('report.date_range'):</label>
                        <input type="text" name="date_range" id="product_pr_date_filter" class="form-control" placeholder="@lang('lang_v1.select_a_date_range')" readonly>
                    </div>
                </div>
            </form>
            @endcomponent
...
@section('javascript')
    ...
    <script>
        $('#location_id').on('change', function() {
            ...
            $.ajax({
                url: '{{ route('getStoresByLocationsProductPurchaseReport') }}',
                type: 'POST',
                data: {
