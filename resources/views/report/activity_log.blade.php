            ...
            @component('components.filters', ['title' => __('report.filters')])
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="al_users_filter" id="al_users_filter" class="form-control select2" style="width:100%">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="subject_type" id="subject_type" class="form-control select2" style="width:100%">
                            <option value="">{{ __('lang_v1.all') }}</option>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="al_date_filter" id="al_date_filter" class="form-control" placeholder="{{ __('lang_v1.select_a_date_range') }}" readonly>
                    </div>
                </div>
