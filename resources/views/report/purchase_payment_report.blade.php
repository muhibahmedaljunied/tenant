        ...
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
                <form method="GET" action="#">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="ppr_date_filter">@lang('report.date_range'):</label>
                            <input type="text" name="date_range" id="ppr_date_filter" class="form-control" placeholder="@lang('lang_v1.select_a_date_range')" readonly>
                        </div>
                    </div>
                </form>
            @endcomponent
