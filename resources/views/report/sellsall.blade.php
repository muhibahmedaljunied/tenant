        ...
        <div class="row">
            <div class="col-md-12">
                @component('components.filters', ['title' =>'تقرير يومية مبيعات'])
                    <form id="sales_representative_filter_form" method="get" action="{{ action('ReportController@getStockReport') }}">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="sr_id2">{{ __('report.user') . ':' }}</label>
                            <select name="sr_id2" id="sr_id2" class="form-control select2" style="width:100%">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="sr_business_id2">{{ __('business.business_location') . ':' }}</label>
                            <select name="sr_business_id2" id="sr_business_id2" class="form-control select2" style="width:100%">
