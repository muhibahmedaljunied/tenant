...
<section class="content">
    ...
    <div class="row">
        <div class="col-sm-12">
            @component('components.widget', ['class' => 'box-primary'])
              <for action="{{ action('ContactController@postImportContacts') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="name">@lang('product.file_to_import'):</label>
        <input type="file" name="contacts_csv" id="name" accept=".xls" required>
    </div>
</div>
            ...
            <</form>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <a href="{{ url('files/import_contacts_csv_template.xls') }}" class="btn btn-success" download><i class="fa fa-download"></i> @lang('lang_v1.download_template_file')</a>
                    </div>
                </div>
            @endcomponent
        </div>
