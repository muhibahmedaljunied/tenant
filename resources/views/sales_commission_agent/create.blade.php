      ...
      <div class="modal-body">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" name="contact_no" id="contact_no" class="form-control" placeholder="{{ __( 'lang_v1.contact_no' ) }}">
          </div>
        </div>
        <div class="col-md-12">
          <div class="form-group">
            <label for="address">{{ __( 'business.address' ) . ':' }}</label>
            <textarea name="address" id="address" class="form-control" placeholder="{{ __( 'business.address') }}" rows="3"></textarea>
          </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" name="cmmsn_percent" id="cmmsn_percent" class="form-control input_number" placeholder="{{ __( 'lang_v1.cmmsn_percent' ) }}" required>
          </div>
        </div>
