            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="alert alert-danger">
                        <ul>
                            @if (!empty($not_linked_payments))
                                <li>@lang('account.payments_not_linked_with_account', ['payments' => $not_linked_payments])
                                    <a
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li>
                                <a href="#account_types" data-toggle="tab">
                                    <i class="fa fa-list"></i> <strong>@lang('lang_v1.account_types')</strong>
                                </a>
                            </li>
                        </ul>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4">
                                            <select name="account_status" id="account_status" class="form-control select2"
                                                ...
                                                <option value="closed">@lang('account.closed')</option>
                                            </select>
                                        </div>
