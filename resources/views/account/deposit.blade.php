  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="amount" id="amount" value="0" class="form-control input_number" required placeholder="{{ __( 'sale.amount' ) }}">
            </div>

            <div class="form-group">
                <label for="from_account">{{ __( 'account.deposit_from' ) .":" }}</label>
            ...
            <div class="form-group">
                ...
                <div class="input-group date" id='od_datetimepicker'>
                  <input type="text" name="operation_date" id="operation_date" value="0" class="form-control" required placeholder="{{ __( 'messages.date' ) }}">
