  ...
  <div class="modal-content">
    ...
    <div class="modal-body">
            <div class="form-group">
                ...
                <input type="text" name="name" id="name" value="{{ $account->name }}" class="form-control" required placeholder="{{ __( 'lang_v1.name' ) }}">
            </div>

             <div class="form-group">
                <label for="account_number">{{ __( 'account.account_number' ) .":*" }}</label>
                <input type="text" name="account_number" id="account_number" value="{{ $account->account_number }}" class="form-control" required placeholder="{{ __( 'account.account_number' ) }}">
            </div>

            <div class="form-group">
                <label for="account_type_id">{{ __( 'account.account_type' ) .":" }}</label>
            ...
            <div class="form-group">
                ...
                <textarea name="note" id="note" class="form-control" placeholder="{{ __( 'brand.note' ) }}" rows="4">{{ $account->note }}</textarea>
            </div>
    </div>
