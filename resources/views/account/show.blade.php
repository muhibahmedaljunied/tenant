                ...
                <div class="box-body">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="transaction_date_range">{{ __('report.date_range') . ':' }}</label>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                <input type="text" name="transaction_date_range" id="transaction_date_range" class="form-control" readonly placeholder="{{ __('report.date_range') }}">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="transaction_type">{{ __('account.transaction_type') . ':' }}</label>
                            <div class="input-group">
