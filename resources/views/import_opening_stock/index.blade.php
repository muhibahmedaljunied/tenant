...
<div class="row">
    <div class="col-sm-12">
        @component('components.widget', ['class' => 'box-primary'])
            <form action="{{ action('ImportOpeningStockController@store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-sm-6">
                        <div class="col-sm-8">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <a href="{{ asset('files/import_opening_stock_csv_template.xls') }}" class="btn btn-success" download>
        ...
        @component('components.widget', ['class' => 'box-primary', 'title' => __('lang_v1.instructions')])
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>@lang('lang_v1.location_ins1')<br></td>
                </tr>
                <tr>
                    <td>3</td>
                ...
                <tr>
                    ...
                    <td>@lang('lang_v1.expiry_date_in_business_date_format')<br><b>{{ $date_format }}</b></td>
                </tr>
            </table>
        @endcomponent
    </div>
