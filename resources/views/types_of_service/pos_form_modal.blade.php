            ...
            <div class="row">
                <div class="form-group col-md-12">
                    ...
                    <div class="input-group" @if($types_of_service->packing_charge_type != 'percent') style="width: 100%;" @endif>
                        <input type="text" name="packing_charge" id="packing_charge" class="form-control input_number" placeholder="{{ __( 'lang_v1.packing_charge') }}" style="width: 100%;" value="{{ @num_format($packing_charge) }}">
                ...
                @if($types_of_service->enable_custom_fields == 1)
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="service_custom_field_1" id="service_custom_field_1" class="form-control" placeholder="{{ $service_custom_field_1 }}" value="{{ !empty($transaction) ? $transaction->service_custom_field_1 : '' }}">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="service_custom_field_2">{{ $service_custom_field_2 }}:</label>
                        <input type="text" name="service_custom_field_2" id="service_custom_field_2" class="form-control" placeholder="{{ $service_custom_field_2 }}" value="{{ !empty($transaction) ? $transaction->service_custom_field_2 : '' }}">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="service_custom_field_3">{{ $service_custom_field_3 }}:</label>
                        <input type="text" name="service_custom_field_3" id="service_custom_field_3" class="form-control" placeholder="{{ $service_custom_field_3 }}" value="{{ !empty($transaction) ? $transaction->service_custom_field_3 : '' }}">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="service_custom_field_4">{{ $service_custom_field_4 }}:</label>
                        <input type="text" name="service_custom_field_4" id="service_custom_field_4" class="form-control" placeholder="{{ $service_custom_field_4 }}" value="{{ !empty($transaction) ? $transaction->service_custom_field_4 : '' }}">
                    </div>
                @endif
            </div>
        </div>
