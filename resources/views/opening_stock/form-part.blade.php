                                ...
                                <tbody>
                                    ...
                                    @foreach ($product->variations as $variation)
                                        @if (empty($purchases[$key][$variation->id]))
                                            @php
                                                $purchases[$key][$variation->id][] = ['quantity' => 0, 'purchase_price' => $variation->default_purchase_price, 'purchase_line_id' => null, 'lot_number' => null, 'patch_number' => null];
                                            @endphp
                                        @endif
                                        ...
                                        @foreach ($purchases[$key][$variation->id] as $sub_key => $var)
                                            ...
                                            <tr>
                                                ...
                                                @if ($enable_patch)
                                                    <td>
                                                        <input type="text" name="stocks[{{ $key }}][{{ $variation->id }}][{{ $sub_key }}][patch_number]" value="{{ $patch_number }}" class="form-control input-sm">
                                                    </td>
                                                @endif
                                                <td>
...
@endif
    @if ($enable_patch)
<td>
            <input class="form-control input-sm" name="stocks[{{ $key }}][{{ $variation->id }}][__subkey__][patch_number]" type="text">
        </td>
@endif
    ...
    <td>&nbsp;</td></tr>'><i
                                ...
                                <tfoot>
                                    <tr>
                                        <td
                                            colspan="@if ($enable_expiry == 1 && $product->enable_stock == 1 && $enable_lot == 1 && $enable_patch) 6 @elseif(($enable_expiry == 1 && $product->enable_stock == 1) || $enable_lot == 1) @else 3 @endif">
                                        </td>
