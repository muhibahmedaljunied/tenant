...
<div class="form-group">
  ...
  <input type="text" name="name" class="form-control" required placeholder="{{ $name_label }}">
</div>

@if($cat_code_enabled)
<div class="form-group">
  <label for="short_code">{{ $cat_code_label }}:</label>
  <input type="text" name="short_code" class="form-control" placeholder="{{ $cat_code_label }}">
...
<div class="form-group">
  ...
  <textarea name="description" class="form-control" rows="3" placeholder="{{ __('lang_v1.description') }}"></textarea>
</div>
