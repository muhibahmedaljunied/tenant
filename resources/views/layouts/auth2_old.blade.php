...
<head>
    ...
    <meta name="description" content="erp4anyone |, المبيعات والمخازن اونلاين بإشتراك شهري">
    <meta name="author" content="erp4anyone">
    <meta property="og:type" content="website" />
    <meta property="og:title" content="erp4anyone - برنامج المحاسبة لإدارة الأنشطة التجارية" />
    <meta property="og:site_name" content="erp4anyone " />
    <meta property="og:image" content="http://erp4anyone/img/logo3.png" />
...
<body style="background-color: #317db7">
                            ...
                            @if (!($request->segment(1) == 'business' && $request->segment(2) == 'register'))
                                ...
                                @if (config('constants.allow_registration'))
                                    <a href="{{ route('business.getRegister') }}@if (!empty(request()->lang)) {{ '?lang=' . request()->lang }} @endif"
                                        class="btn  btn-flat"><b>{{ __('business.not_yet_registered') }}</b>
    ...
    <!-- Scripts -->
    <script src="{{ url('js/login.js?v=' . $asset_v) }}"></script>
