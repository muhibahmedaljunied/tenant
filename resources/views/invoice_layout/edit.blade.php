      ...
      <div class="row">
        ...
        <div class="col-sm-6">
         <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control" required placeholder="{{ __('invoice.layout_name') }}" value="{{ old('name', $invoice_layout->name) }}">
          </div>
        </div>
          ...
          <div class="form-group">
            ...
            <select name="design" id="design" class="form-control">
              @foreach($designs as $key => $value)
                <option value="{{ $key }}" @if(old('design', $invoice_layout->design) == $key) selected @endif>{{ $value }}</option>
              @endforeach
            </select>
      ...
      <div class="box-body">
        ...
        <div class="col-sm-4" style="display: none">
          <div class="form-group">
            ...
            <input type="text" name="tax_number" id="tax_number" class="form-control" value="{{ old('tax_number', $invoice_layout->tax_number) }}">
          </div>
        </div>
        <div class="col-sm-4" style="display: none">
          <div class="form-group">
            <label for="commercial_register">{{ __('lang_v1.commercial_register') . ':' }}</label>
            <input type="text" name="commercial_register" id="commercial_register" class="form-control" value="{{ old('commercial_register', $invoice_layout->commercial_register) }}">
          </div>
        </div>
        <div class="col-sm-4"  style="display: none">
          <div class="form-group">
            <label for="tax_number2">{{ __('lang_v1.tax_number') . ' 2:' }}</label>
            <input type="text" name="tax_number2" id="tax_number2" class="form-control" value="{{ old('tax_number2', $invoice_layout->tax_number2) }}">
          </div>
        </div>
        ...
        @if(request()->session()->get('business.enable_patch_number') == 1)
          <div class="col-sm-3">
            <div class="form-group">
              <div class="checkbox">
                <label>
                  {!! Form::checkbox('show_patch_number', 1, $invoice_layout->show_patch_number, ['class' => 'input-icheck']); !!} @lang('lang_v1.show_patch_number')</label>
                </div>
            </div>
          </div>
        @endif
