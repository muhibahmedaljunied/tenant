            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control"
                            required placeholder="@lang('unit.name')">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="priority" id="priority" class="form-control input_number"
                            required placeholder="@lang('lang_v1.priority')">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="discount_amount" id="discount_amount" class="form-control input_number"
                            required placeholder="@lang('sale.discount_amount')">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="starts_at" id="starts_at" class="form-control discount_date"
                            required placeholder="@lang('lang_v1.starts_at')" readonly>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="ends_at" id="ends_at" class="form-control discount_date"
                            required placeholder="@lang('lang_v1.ends_at')" readonly>
                    </div>
                </div>
            </div>
        </div>
