...
<section class="content">
                            ...
                            <tr>
                                <td colspan="11">
                                    <div style="display: flex; width: 100%;">
                                        <form action="{{ action('DiscountController@massDeactivate') }}" method="POST" id="mass_deactivate_form">
                                            @csrf
    ...
    <div class="modal fade discount_modal" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel"></div>
</section>
