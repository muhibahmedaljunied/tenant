...
<div class="table-responsive">
    ...
    @foreach($purchase->purchase_lines as $purchase_line)
        <tr>
            ...
            <td>
                {{ $purchase_line->product->name }} ({{ $purchase_line->related_variations->sub_sku ?? $purchase_line->variations->sub_sku}})
            ...
            <td>
                ...
                <input type="hidden" name="purchases[{{ $loop->index }}][variation_id]" value="{{ $purchase_line->related_variation_id ?? $purchase_line->variation_id }}">
                ...
                <input type="text" 
                    ...
                    value="{{ number_format(($purchase_line->main_qty), $quantity_precision, $currency_details->decimal_separator, $currency_details->thousand_separator) }}"
                ...
                @else
                    {{ $purchase_line->related_variations->unit->short_name ?? $purchase_line->product->unit->short_name }}
                @endif
            ...
            <td>
                <input type="text" 
                    name="purchases[{{ $loop->index }}][pp_without_discount]" 
            ...
            <td>
                <input type="text" 
                    name="purchases[{{ $loop->index }}][discount_percent]" 
            ...
            <td>
                <input type="text" 
                    name="purchases[{{ $loop->index }}][purchase_price]" 
            ...
            <td class="{{$hide_tax}}">
                <span class="row_subtotal_before_tax">
                    {{number_format(($purchase_line->main_qty) * $purchase_line->purchase_price/$purchase->exchange_rate, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator)}}
                </span>
                <input type="hidden" class="row_subtotal_before_tax_hidden" value="{{number_format(($purchase_line->main_qty) * $purchase_line->purchase_price/$purchase->exchange_rate, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator)}}">
            </td>
            ...
            <td class="{{$hide_tax}}">
                <div class="input-group">
                    ...
                    <input type="hidden" 
                        name="purchases[{{ $loop->index }}][item_tax]" 
            ...
            <td class="{{$hide_tax}}">
                <input type="text" 
                    name="purchases[{{ $loop->index }}][purchase_price_inc_tax]" 
            ...
            <td>
                ...
                {{number_format($purchase_line->purchase_price_inc_tax * $purchase_line->main_qty/$purchase->exchange_rate, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator)}}
                </span>
                <input type="hidden" class="row_subtotal_after_tax_hidden" value="{{number_format($purchase_line->purchase_price_inc_tax * $purchase_line->main_qty/$purchase->exchange_rate, $currency_precision, $currency_details->decimal_separator, $currency_details->thousand_separator)}}">
            </td>
            ...
            <td class="@if(!session('business.enable_editing_product_from_purchase')) hide @endif">
                ...
                <input type="text" 
                    name="purchases[{{ $loop->index }}][profit_percent]" 
            ...
            <td>
                @if(session('business.enable_editing_product_from_purchase'))
                    <input type="text" 
                        name="purchases[{{ $loop->index }}][default_sell_price]" 
            ...
            @if(session('business.enable_lot_number'))
                <td>
                    <input type="text" 
                        name="purchases[{{ $loop->index }}][lot_number]" 
                        value="{{ $purchase_line->lot_number }}" 
            ...
            @if(session('business.enable_patch_number'))
                <td>
                    <input type="text" 
                        name="purchases[{{ $loop->index }}][patch_number]" 
                        value="{{ $purchase_line->patch_number }}" 
                        class="form-control input-sm"
                    >
                </td>
            @endif
            ...
            @if(session('business.enable_product_expiry'))
                <td style="text-align: left;">
                    ...
                    <div class="input-group @if($hide_mfg) hide @endif">
                        ...
                        <input type="text" 
                            name="purchases[{{ $loop->index }}][mfg_date]" 
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" 
                            name="purchases[{{ $loop->index }}][exp_date]" 
