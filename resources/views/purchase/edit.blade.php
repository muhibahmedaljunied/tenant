...
@section('content')
    ...
    <section class="content">
        ...
        <form action="{{ action('PurchaseController@update', [$purchase->id]) }}" method="POST" id="add_purchase_form"
                        ...
                        <div class="form-group">
                            ...
                            <select name="location_id" class="form-control select2" id="location_id" disabled>
                                ...
                                @foreach ($business_locations as $key => $value)
                                    <option value="{{ $key }}" @if ($purchase->location_id == $key) selected @endif>
                                        {{ $value }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="multi-input">
                                ...
                                <input type="number" name="pay_term_number" id="pay_term_number"
                                    value="{{ $purchase->pay_term_number }}" class="form-control width-40 pull-left"
                                    placeholder="{{ __('contact.pay_term') }}">
                                <select name="pay_term_type" class="form-control width-60 pull-left" id="pay_term_type">
                                    <option value="">{{ __('messages.please_select') }}</option>
                                    <option value="months" @if ($purchase->pay_term_type == 'months') selected @endif>
                                        {{ __('lang_v1.months') }}</option>
                                    <option value="days" @if ($purchase->pay_term_type == 'days') selected @endif>
                        ...
                        <table class="table">
                                ...
                                <td class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="discount_type" class="form-control select2" id="discount_type">
                                            ...
                                            <option value="fixed" @if ($purchase->discount_type == 'fixed') selected @endif>
                                                {{ __('lang_v1.fixed') }}</option>
                                            <option value="percentage" @if ($purchase->discount_type == 'percentage') selected @endif>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="shipping_details" id="shipping_details"
                                            value="{{ $purchase->shipping_details }}" class="form-control">
                                    </div>
                                </td>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                                <td>
                                    <div class="form-group">
                                        <label
                                            for="shipping_charges">{{ '(+) ' . __('purchase.additional_shipping_charges') . ':' }}</label>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <button type="submit" id="submit_purchase_form"
