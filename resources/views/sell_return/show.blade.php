      ...
      <div class="col-sm-12">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  @if ($sell_line->unit_equal_qty)
                  {{@format_quantity($sell_line->quantity_returned / $sell_line->unit_equal_qty)}} 
                    @else
                  {{@format_quantity($sell_line->quantity_returned)}} 
                  @endif
                  {{$unit_name}}</td>
                <td>
                  @php
                    $line_total = $sell_line->unit_price_inc_tax * ($sell_line->quantity_returned / $sell_line->unit_equal_qty);
