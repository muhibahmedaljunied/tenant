<table class="table bg-gray">
    ...
    @foreach($sell->sell_lines as $sell_line)
        <tr>
            ...
            @endif
            <td>
                <span class="display_currency" data-currency_symbol="false" data-is_quantity="true">{{ $sell_line->main_qty }}</span> @if(!empty($sell_line->sub_unit)) {{$sell_line->sub_unit->short_name}} @else {{$sell_line->related_variations->unit->short_name  ?? $sell_line->product->unit->short_name}} @endif
            </td>
            @if(!empty($pos_settings['inline_service_staff']))
                <td>
            ...
            <td>
                <span class="display_currency" data-currency_symbol="true">{{ $sell_line->main_qty * $sell_line->unit_price_inc_tax }}</span>
            </td>
        </tr>
        ...
        @foreach($sell_line->modifiers as $modifier)
            <tr>
                ...
                <td>
                    <span class="display_currency" data-currency_symbol="true">{{ $modifier->main_qty * $modifier->unit_price_inc_tax }}</span>
                </td>
            </tr>
            @endforeach
        @endif
