                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="form-group">
                            <label for="weighing_scale_barcode">{{ __('lang_v1.weighing_scale_barcode') }}:</label>
                            @show_tooltip(__('lang_v1.weighing_scale_barcode_help'))
                            <input type="text" name="weighing_scale_barcode" id="weighing_scale_barcode" class="form-control">
                        </div>
                    </div>
                </div>
            </div>
