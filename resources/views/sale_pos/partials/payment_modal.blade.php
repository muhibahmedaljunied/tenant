			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-12 mb-12">
						...
						<input type="hidden" name="advance_balance" id="advance_balance" data-error-msg="{{ __('lang_v1.required_advance_balance_not_available') }}">
					</div>
				<div class="col-md-9">
						<div class="row">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<textarea name="sale_note" id="sale_note" class="form-control" rows="3" placeholder="{{ __('sale.sell_note') }}">{{ !empty($transaction)? $transaction->additional_notes : '' }}</textarea>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
									<label for="staff_note">{{ __('sale.staff_note') . ':' }}</label>
									<textarea name="staff_note" id="staff_note" class="form-control" rows="3" placeholder="{{ __('sale.staff_note') }}">{{ !empty($transaction)? $transaction->staff_note : '' }}</textarea>
								</div>
							</div>
						</div>
					</div>
