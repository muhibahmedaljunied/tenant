        ...
        <div class="form-group">
            <div class="input-group">
                ...
                <select name="contact_id" id="customer_id" class="form-control mousetrap" required style="width: 100%;">
                    ...
                    {{-- Options should be loaded dynamically via JS --}}
                </select>
            ...
            <div class="form-group">
                <select name="invoice_layout_id" id="invoice_layout_id" class="form-control select2">
                    ...
                    @foreach ($invoice_layouts as $id => $name)
                        <option value="{{ $id }}" @if ($default_location->invoice_layout_id == $id) selected @endif>
                            {{ $name }}</option>
                    @endforeach
                </select>
            </div>
                ...
                <div class="input-group">
                    ...
                    <select name="price_group" id="price_group" class="form-control select2">
                        @foreach ($price_groups as $id => $name)
                            <option value="{{ $id }}" @if ($selected_price_group == $id) selected @endif>
                                {{ $name }}</option>
                        @endforeach
                    </select>
                    <span class="input-group-addon">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <select name="types_of_service_id" id="types_of_service_id" class="form-control"
                        ...
                        @foreach ($types_of_service as $id => $name)
                            <option value="{{ $id }}">{{ $name }}</option>
                        @endforeach
                    </select>
            ...
            <div class="form-group">
                <select name="invoice_scheme_id" class="form-control">
                    ...
                    @foreach ($invoice_schemes as $id => $name)
                        <option value="{{ $id }}" @if ($default_invoice_schemes->id == $id) selected @endif>
                            {{ $name }}</option>
                    @endforeach
                </select>
            </div>
    ...
    @if (in_array('subscription', $enabled_modules))
        <div class="col-md-4 col-sm-6">
            ...
            <button type="button" data-toggle="modal" data-target="#recurringInvoiceModal" class="btn btn-link"><i
                    class="fa fa-external-link-square-alt"></i></button>
