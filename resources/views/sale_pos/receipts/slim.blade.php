...
<html lang="en">
    ...
    @if ($transaction->payment_status == 'partial' || $transaction->payment_status == 'due')
        @if (isset($transaction->installment) && count($transaction->installment) > 0)
    ...
    @endif
        ...
        <div class="ticket">
			...
			@if($receipt_details->show_qr_code && !empty($receipt_details->qr_code_gen))
				<img class="center-block mt-5" src="data:image/png;base64,{{DNS2D::getBarcodePNG($receipt_details->qr_code_gen, 'QRCODE')}}">
			@endif
