...
<body>
    ...
    <div class="ticket" style="margin:5px!important;padding: 5px">
        ...
        <div class="text-box">
            ...
            <div class="row">
                ...
                <div class="col-6 " style="padding-left: 40px;padding-top: 5px;padding-bottom: 5px">
                    <div
                        style="border:2px solid rgba(126,186,238,0.93);float: left;padding: 5px;border-radius: 10px 0px">
            ...
            <div class="row div-content" style=" margin-right:0px ;margin-left: 10px">
                ...
                <div class="col-xs-3 sell-div">
                    <p class="centered">
                        ...
                        @endif --}}
                    <h5><b>رقم السجل الضريبي</b></h5>
                    <h5> {{ $receipt_details->tax_info1 ?? 'الرقم غير مسجل' }} </h5>
                    {{-- @if (!empty($receipt_details->tax_label1))
                        @else
                            <h5><b>رقم السجل الضريبي</b></h5>
                            <h5> الرقم غير مسجل </h5>
                ...
                @forelse($receipt_details->lines as $line)
                    <tr>
                        ...
                        <td class="text-right">
                            ...
                            @php
                                $total = $total + $line['line_total_uf'];
                                $tax = $tax + $line['tax_unformatted'] * $line['quantity_uf'];
                            @endphp
                        </td>
                        <td class="text-right">
                            {{ $line['tax_percent'] ?? 0 }} %
        ...
        <table>
            <tr>
                <td>
                    <p class="f-right">المجموع غير شامل الضريبه :</p>
                </td>
                <td>
                    {{ $total }}
                </td>
            ...
            @unless (empty($receipt_details->left_subscription_balance))
                <tr>
                    <td>
                        <p class="f-right">
                    ...
                    <td>
                        <p>
                            {{ $receipt_details->left_subscription_balance }}
                        </p>
                    </td>
                </tr>
            @endunless
