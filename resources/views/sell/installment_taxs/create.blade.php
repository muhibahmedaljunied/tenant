<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <form action="{{ action('TaxRateController@store') }}" method="POST" id="tax_rate_add_form_inst">
      @csrf
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label for="count_months">{{ __( 'عدد الشهور لفائدة القسط فقط' ) . ':' }}</label> @show_tooltip('خاص بفائدة القسط ')
          <input type="text" name="count_months" id="count_months" class="form-control input_number">
        </div>
        ...
        <div class="form-group">
          <div class="checkbox">
            <label>
              <input type="checkbox" name="is_composite" value="1" class="input_icheck"> @lang( 'فايدة مركبة' )
            </label> @show_tooltip(__('lang_v1.for_tax_group_only_help'))
          </div>
        </div>
      </div>
