                       ...
                       <tr>
                           <td class="no-print">
                               ...
                               <div class="row" style="width:400px">
                                   <div class="col-md-6">
                                       <label>{{ __('lang_v1.date') . ':' }}</label>
                                       <input type="date" id="pay_date_{{$row->id}}" onChange='cal_fine({{$row->id}},{{$row->amount}},<?php echo '"'.$row->due_at.'"'?>);' class="form-control" >
                                   </div>
                                   <div class="col-md-6">
                                       <div class="form-group ">
                    			    <label>{{ __('lang_v1.payment_account') . ':' }}</label>
                        		    <div class="input-group">
                            			<span class="input-group-addon">
                            				<i class="fas fa-money-bill-alt"></i>
                            			</span>
                            			<select name="account" required class="form-control select2 account-dropdown" id="account_{{$row->id}}" style="width:100%;">
