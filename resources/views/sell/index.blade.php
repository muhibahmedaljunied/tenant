                        ...
                        @if ($is_woocommerce)
                            <div class="col-md-3">
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="only_woocommerce_sells" id="synced_from_woocommerce"
                                                class="input-icheck" value="1">
                                            @lang('lang_v1.synced_from_woocommerce')
                                        </label>
                                    </div>
                                </div>
                            </div>
                ...
                <table class="table table-bordered table-striped ajax_view" id="sell_table">
                    <thead>
                        <tr>
                            ...
                            <th>@lang('zatca.sent_status_invoice')</th>
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            if (!locationIds) {
                $('#sell_list_filter_store_id').html(
            ...
            $(document).on('change',
                '#sell_list_filter_location_id,#sell_list_filter_store_id, #sell_list_filter_customer_id, #sell_list_filter_payment_status, #created_by, #sales_cmsn_agnt, #service_staffs, #shipping_status',
                function() {
                    sell_table.ajax.reload();
                });
            @if ($is_woocommerce)
