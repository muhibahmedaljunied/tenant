                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="stock_expiry_alert_days">{{ __('نسبة الغرامة المركبة للتأخير') . ':*' }}</label>
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                            <i class="fas fa-dollar-sign"></i>
                                        </span>
                                        <input type="number" name="composite_fine" id="composite_fine" value="{{ $business->composite_fine }}" class="form-control" required>
                                        <span class="input-group-addon">
