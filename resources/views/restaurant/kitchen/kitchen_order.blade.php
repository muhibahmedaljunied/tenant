            ...
            @component('components.filters', ['title' => __('report.filters')])
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="kitchen">المطبخ:</label>
                        <select id="kitchen" name="kitchen" class="form-control select2" style="width:100%">
    ...
    <section class="content ">
        <div class="box">
            <div class="box-header">
                <button type="button" class="btn btn-sm btn-primary pull-right" onclick="getdata()" id="refresh_orders"><i
