		...
		@if(in_array('tables', $enabled_modules) )
			...
			<div class="col-sm-3">
				<div class="form-group">
					...
					<input type="text" name="module_info[tables][table_label]" id="module_info[tables][table_label]" class="form-control" placeholder="{{ __('restaurant.table_label') }}" value="{{ $default['table_label'] }}">
				</div>
			</div>
		@endif
		@if(in_array('service_staff', $enabled_modules) )
			...
			<div class="col-sm-3">
				<div class="form-group">
					...
					<input type="text" name="module_info[service_staff][service_staff_label]" id="module_info[service_staff][service_staff_label]" class="form-control" placeholder="{{ __('restaurant.service_staff_label') }}" value="{{ $default['service_staff_label'] }}">
				</div>
			</div>
		@endif
