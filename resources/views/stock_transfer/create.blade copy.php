...
<form action="{{ action('StockTransferController@store') }}" method="post" id="stock_transfer_form">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input type="text" id="transaction_date" name="transaction_date" value="{{ @format_datetime('now') }}" class="form-control" readonly required>
        </div>
    </div>
</div>
...
<div class="col-sm-6">
    <div class="form-group">
        ...
        <select id="transfer_location_id" name="transfer_location_id" class="form-control select2" required>
            <option value="">{{ __('messages.please_select') }}</option>
            @foreach($business_locations as $key => $value)
                <option value="{{ $key }}">{{ $value }}</option>
            @endforeach
    ...
    <div class="input-group">
        ...
        <input type="text" id="search_product_for_srock_adjustment" name="search_product" class="form-control" placeholder="{{ __('stock_adjustment.search_product') }}" disabled>
    </div>
</div>
    ...
    <div class="form-group">
        ...
        <input type="text" id="shipping_charges" name="shipping_charges" value="0" class="form-control input_number" placeholder="{{ __('lang_v1.shipping_charges') }}">
    </div>
</div>
