...
@section('content')
    ...
    <div class=""
        style="background-color: white; padding: 10px 30px 30px 30px;border-radius: 10px;max-width: 350px;margin: auto; margin-top: 70px;">
        ...
        <div
            ...
            <h3 style="color: #FFFFFF">{{ env('APP_TITLE', 'SHARF-ERP') }}</h3>
        ...
        <form method="POST" action="{{ route('login') }}" id="login-form">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary btn-flat btn-login"
                    style="border-radius: 10px;height: 50px;font-size: 19px;">@lang('lang_v1.login')</button>
    ...
    <div class=""
        style="text-align: center;background-color: white; padding: 6px 10px 15px 10px;border-radius: 10px;max-width: 350px;margin: auto; margin-top: 70px;">
        <h3>لتجربة البرنامج يمكنك الضغط هنا </h3>
        <button type="button" class="btn btn-danger btn-flat btn-login"
            style="border-radius: 10px;height: 50px;font-size: 19px;" id="test">تجربة البرنامج </button>
