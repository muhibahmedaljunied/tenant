    ...
    <div class="modal-body">
      <div class="row">
        <div class="form-group col-sm-12">
          ...
          <input type="text" name="actual_name" value="{{ $unit->actual_name }}" class="form-control" required placeholder="{{ __('unit.name') }}">
        </div>

        <div class="form-group col-sm-12">
          <label for="short_name">{{ __('unit.short_name') }}:*</label>
          <input type="text" name="short_name" value="{{ $unit->short_name }}" class="form-control" required placeholder="{{ __('unit.short_name') }}">
        </div>
        ...
        <div class="form-group col-sm-12">
          <div class="checkbox">
            <label>
              <input type="checkbox" name="define_base_unit" value="1" class="toggler" data-toggle_id="base_unit_div" {{ !empty($unit->base_unit_id) ? 'checked' : '' }}>
          ...
          <table class="table">
            <tr>
              ...
              <td style="vertical-align: middle;">
                <input type="text" name="base_unit_multiplier" value="{{ !empty($unit->base_unit_multiplier) ? number_format($unit->base_unit_multiplier) : '' }}" class="form-control input_number" placeholder="{{ __('lang_v1.times_base_unit') }}">
              </td>
              <td style="vertical-align: middle;">
