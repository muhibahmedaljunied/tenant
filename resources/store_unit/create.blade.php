    ...
    <div class="modal-body">
      <div class="row">
        <div class="form-group col-sm-12">
          ...
          <input type="text" name="actual_name" class="form-control" required placeholder="{{ __('unit.name') }}">
        </div>

        <div class="form-group col-sm-12">
          <label for="short_name">{{ __('unit.short_name') }}:*</label>
          <input type="text" name="short_name" class="form-control" required placeholder="{{ __('unit.short_name') }}">
        </div>
