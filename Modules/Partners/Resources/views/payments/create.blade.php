<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        <form action="{{ action('\\Modules\\Partners\\Http\\Controllers\\PaymentsController@store') }}" method="POST" id="addpayment">
            @csrf
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="date" id="date" class="form-control date-picker" required placeholder="{{ __('partners.purchasedate') }}" value="{{ old('date') }}" readonly>
                    </div>
                </div>
