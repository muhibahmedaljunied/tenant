                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-3">
                            <div class="form-group">
                                ...
                                <select name="partner_id" id="partner_id" class="form-control select2" style="width:100%">
                        ...
                        <div class="col-lg-2 col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="startdate" id="startdate_from" class="form-control start-date-picker" placeholder="{{ __('partners.purchasedate') }}" value="{{ old('startdate') }}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="enddate" id="startdate_to" class="form-control start-date-picker" placeholder="{{ __('partners.purchasedate') }}" value="{{ old('enddate') }}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-3">
                            <div class="form-group">
                                ...
                                <select name="type" id="type" class="form-control select2" style="width:100%">
                                    <option value="0" {{ old('type') == '0' ? 'selected' : '' }}>الكل</option>
