        ...
        <div class="row" >
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="capital" id="capital" value="{{ $business_data->capital }}" class="form-control decimal" required placeholder="الإسم">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="sharenumber">عدد الأسهم :</label>
                    <input type="text" name="sharenumber" id="sharenumber" value="{{ $business_data->sharenumber }}" class="form-control" required placeholder="الإسم">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <input type="text" name="capital_rem" id="capital_rem" value="{{ $business_data->capital - $totalcapital }}" class="form-control decimal" readonly placeholder="الإسم">
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for="sharenumber_rem">الباقي من عدد الأسهم :</label>
                    <input type="text" name="sharenumber_rem" id="sharenumber_rem" value="{{ $business_data->sharenumber - $totalshare }}" class="form-control" readonly placeholder="الإسم">
                </div>
            </div>
        </div>
    </div>
