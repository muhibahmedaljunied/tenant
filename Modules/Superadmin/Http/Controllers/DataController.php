...
class DataController extends Controller
{
    ...
    public function modifyAdminMenu($menuItems)
    {
        ...
        //             $sub->url(
        //                 action('\Modules\Superadmin\Http\Controllers\SuperadminController@change_business'),
        //                 __('superadmin::lang.change_business'),
        //                 ['icon' => 'fa fas fa-envelope', 'active' => request()->segment(1) == 'superadmin' && request()->segment(2) == 'change-business']
        //             );
        //         },
        ...
        if (auth()->user()->can('superadmin')) {
            ...
            $menuItems[] =
                [
                    'name' => __('superadmin::lang.superadmin'),
                    'icon' => 'fa fas fa-users-cog',
                    'order' => 1,
                    'sub' => [
                        [
                            'name' => __('superadmin::lang.superadmin'),
                            'url' => action('\Modules\Superadmin\Http\Controllers\SuperadminController@index'),
                            'icon' => 'fa fas fa-users-cog',
                            'active' => request()->segment(1) == 'superadmin' && request()->segment(2) == null,
                        ],
                        [
                            'name' => __('superadmin::lang.all_business'),
                            'url' => action('\Modules\Superadmin\Http\Controllers\BusinessController@index'),
                            'icon' => 'fa fas fa-landmark',
                            'active' => request()->segment(1) == 'superadmin' && request()->segment(2) == 'business',
                        ],
                        [
                            'name' => __('superadmin::lang.subscription'),
                            'url' => action('\Modules\Superadmin\Http\Controllers\SuperadminSubscriptionsController@index'),
                            'icon' => 'fa fas fa-sync',
                            'active' => request()->segment(1) == 'superadmin' && request()->segment(2) == 'superadmin-subscription',
                        ],
                        [
                            'name' => __('superadmin::lang.subscription_packages'),
                            'url' => action('\Modules\Superadmin\Http\Controllers\PackagesController@index'),
                            'icon' => 'fa fas fa-credit-card',
                            'active' => request()->segment(1) == 'superadmin' && request()->segment(2) == 'packages',
                        ],
                        [
                            'name' => __('superadmin::lang.super_admin_settings'),
                            'url' => action('\Modules\Superadmin\Http\Controllers\SuperadminSettingsController@edit'),
                            'icon' => 'fa fas fa-cogs',
                            'active' => request()->segment(1) == 'superadmin' && request()->segment(2) == 'settings',
                        ],
                        [
                            'name' => __('superadmin::lang.communicator'),
                            'url' => action('\Modules\Superadmin\Http\Controllers\CommunicatorController@index'),
                            'icon' => 'fa fas fa-envelope',
                            'active' => request()->segment(1) == 'superadmin' && request()->segment(2) == 'communicator',
                        ],
                        [
                            'name' => __('superadmin::lang.change_business'),
                            'url' => action('\Modules\Superadmin\Http\Controllers\SuperadminController@change_business'),
                            'icon' => 'fa fas fa-envelope',
                            'active' => request()->segment(1) == 'superadmin' && request()->segment(2) == 'change-business',
                        ],
                    ],
                ];
        }
        ...
        //         [
        //             'name' => __('superadmin::lang.subscription'),
        //             'url' => action('\Modules\Superadmin\Http\Controllers\SubscriptionController@index'),
        //             'icon' => 'fa fas fa-sync',
        ...
        // ->with(compact('menuItems'));
        // return view('superadmin::layouts.partials.sidebar',compact('menuItems'));
