				...
				<div class="row">
					<div class="col-sm-3">
						<div class="form-group">
							...
							<input type="text" name="title" id="title" class="form-control" placeholder="{{ __('superadmin::lang.page_title') }}" value="{{ old('title') }}">
						</div>
					</div>
					<div class="col-sm-3">
						<div class="form-group">
							<label for="slug">{{ __('superadmin::lang.slug') }}:</label>
							<input type="text" name="slug" id="slug" class="form-control" placeholder="{{ __('superadmin::lang.slug') }}" value="{{ old('slug') }}" required>
						</div>
					</div>
					<div class="col-sm-3">
						<div class="form-group">
							<label for="menu_order">{{ __('superadmin::lang.menu_order') }}:</label> @show_tooltip(__('superadmin::lang.menu_order_tooltip'))
							<input type="number" name="menu_order" id="menu_order" class="form-control" placeholder="{{ __('superadmin::lang.menu_order') }}" value="{{ old('menu_order', 0) }}">
						</div>
					</div>
					<div class="col-sm-3">
						<div class="checkbox">
							<label>
								<input type="checkbox" name="is_shown" value="1" class="input-icheck" {{ old('is_shown', true) ? 'checked' : '' }}>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="form-group">
							...
							<textarea name="content" id="content" class="form-control" placeholder="{{ __('superadmin::lang.page_content') }}">{{ old('content') }}</textarea>
						</div>
					</div>
				</div>
			</div>
