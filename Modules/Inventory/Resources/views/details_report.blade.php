...
<section class="content">
    ...
    <div class="form-group">
        <label for="locations">الفرع:</label>
        <select id="locations" name="locations" class="form-control select2" style="width:100%">
...
<div class="col-md-3">
    <div class="form-group">
        <label for="current_stock">{{ __('report.current_stock') }}:</label>
        <select id="current_stock" name="current_stock" class="form-control select2" style="width:100%">
            <option value="zero">{{ __('inventory::lang.stock_equal') }}</option>
            <option value="gtzero">{{ __('inventory::lang.stock_plus') }}</option>
            <option value="lszero">{{ __('inventory::lang.stock_minus') }}</option>
        </select>
    </div>
</div>
...
<div class="col-md-3 hidden">
    <div class="form-group">
        <label for="default_selling_price">{{ __('lang_v1.default_selling_price') }}:</label>
        <div class="input-group">
            <input type="text" class="form-control" id="default_selling_price" name="default_selling_price" value="">
            <span class="input-group-btn">
                <button type="button" class="btn btn-default bg-white btn-flat btn-modal" title="{{ __('unit.add_unit') }}">
...
<div class="col-md-3 hidden">
    <div class="form-group">
        ...
        <select id="stock_status" name="stock_status" class="form-control select2">
            <option value="0">الكل</option>
            <option value="1">{{ __('inventory::lang.stoking_product') }}</option>
            <option value="2">{{ __('inventory::lang.not_stoking_product') }}</option>
        </select>
    </div>
</div>
...
<div class="col-md-3">
    ...
    <div id="getmore" style="margin: auto;margin-top: 10px">
        ...
        <button class="btn btn-danger" onclick="getallproducts()"><i class="fa fa-refresh fa-spin"></i>
            @lang('inventory::lang.get_all') </button>
    </div>
