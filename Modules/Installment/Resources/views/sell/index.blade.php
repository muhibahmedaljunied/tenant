            ...
            @if (empty($only) || in_array('sell_list_filter_location_id', $only))
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="sell_list_filter_location_id" name="sell_list_filter_location_id" class="form-control select2"
                            style="width:100%">
            ...
            @if (empty($only) || in_array('sell_list_filter_customer_id', $only))
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="sell_list_filter_customer_id" name="sell_list_filter_customer_id"
            ...
            @if (empty($only) || in_array('sell_list_filter_payment_status', $only))
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select id="sell_list_filter_payment_status" name="sell_list_filter_payment_status"
                            class="form-control select2" style="width:100%">
                            <option value="">{{ __('lang_v1.all') }}</option>
                            ...
                            <option value="installmented">{{ __('lang_v1.installmented') }}</option>
                        </select>
                    </div>
                </div>
            @endif
            ...
            @if (empty($only) || in_array('sell_list_filter_date_range', $only))
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" id="sell_list_filter_date_range" name="sell_list_filter_date_range"
