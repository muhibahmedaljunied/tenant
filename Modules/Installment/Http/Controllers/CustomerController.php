...
class CustomerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('installment::customer.index', compact('menuItems'), ['customers' => $customers, 'systems' => $systems]);
    }
    ...
    public function contacts(Request $request)
    {
     $menuItems = $request->menuItems;
        ...
        return view('installment::customer.contacts',compact('menuItems'), ['customers' => $customers]);
    }
