                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="assigned_to_filter">{{ __('project::lang.assigned_to') }}:</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="priority_filter">{{ __('project::lang.priority') }}:</label>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="due_date_filter">{{ __('project::lang.due_date') }}:</label>
