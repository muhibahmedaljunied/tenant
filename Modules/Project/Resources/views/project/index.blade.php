...
<section class="content">
    ...
    <div class="col-md-3 project_status_filter">
        <div class="form-group">
            <label for="project_status_filter">{{ __('sale.status') }}:</label>
            <select name="project_status_filter" id="project_status_filter" class="form-control select2" style="width: 100%;">
...
<div class="col-md-3">
    <div class="form-group">
        <label for="project_end_date_filter">{{ __('project::lang.end_date') }}:</label>
        <select name="project_end_date_filter" id="project_end_date_filter" class="form-control select2" style="width: 100%;">
            <option value="">{{ __('messages.all') }}</option>
            @foreach($due_dates as $id => $name)
                <option value="{{ $id }}">{{ $name }}</option>
            @endforeach
        </select>
    </div>
...
<div class="col-md-3">
    <div class="form-group">
        <label for="project_categories_filter">{{ __('project::lang.category') }}:</label>
        <select name="project_categories_filter" id="project_categories_filter" class="form-control select2" style="width:100%;">
            <option value="">{{ __('messages.all') }}</option>
