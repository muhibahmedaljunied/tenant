<form action="{{ action('\\Modules\\Project\\Http\\Controllers\\ProjectController@postSettings', ['project_id' => $project->id]) }}" id="settings_form" method="POST">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="checkbox">
                <label>
                  <input type="checkbox" name="enable_timelog" value="1" @if(isset($project->settings['enable_timelog']) && $project->settings['enable_timelog']) checked @endif> @lang('project::lang.enable_timelog')
                </label>
            </div>
        </div>
        <div class="col-md-4">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group form-inline">
                <label for="task_id_prefix">{{ __('project::lang.task_id_prefix') }}:*</label>
                <input type="text" name="task_id_prefix" id="task_id_prefix" class="form-control" required value="{{ $task_id_prefix }}">
           </div>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <input type="checkbox" id="members_crud_timelog" name="members_crud_timelog" value="1" @if(isset($project->settings['members_crud_timelog']) && $project->settings['members_crud_timelog']) checked @endif>
        </div>
    </div>
    <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <input type="checkbox" id="members_crud_note" name="members_crud_note" value="1" @if(isset($project->settings['members_crud_note']) && $project->settings['members_crud_note']) checked @endif>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
