...
"),
        ...
        return view('manufacturing::production.index', compact('menuItems'));
    }
     ...
     * @return Response
     */
    public function getManufacturingReport(Request $request)
    {
        $business_id = request()->session()->get('user.business_id');
        ...
        $menuItems = $request->menuItems;
        return view('manufacturing::production.report')->with(compact('business_locations', 'menuItems'));
    }
}
