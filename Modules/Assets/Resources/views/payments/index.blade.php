                        ...
                        <div class="col-lg-2 col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="startdate" id="startdate" class="form-control start-date-picker" placeholder="{{ __('Assets.purchasedate') }}" readonly value="{{ old('startdate') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="enddate" id="enddate" class="form-control start-date-picker" placeholder="{{ __('Assets.purchasedate') }}" readonly value="{{ old('enddate') }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-3">
