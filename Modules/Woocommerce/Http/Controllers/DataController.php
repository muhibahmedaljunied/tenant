...
class DataController extends Controller
{
    ...
    public function modifyAdminMenu()
    {
        ...
        if ($is_woo_enabled && (
            ...
            $woocommerceMenu = [
                'title' => __('woocommerce::lang.woocommerce'),
        ...
        //                     ['icon' => 'fa fas fa-sync', 'active' => request()->segment(1) == 'woocommerce' &&
        ...
        //                     ['icon' => 'fa fas fa-history', 'active' => request()->segment(1) == 'woocommerce' &&
        //                         request()->segment(2) == 'view-sync-log']
        //                 );
        ...
        //                         ['icon' => 'fa fas fa-cogs', 'active' => request()->segment(1) == 'woocommerce' &&
        //                             request()->segment(2) == 'api-settings']
        //                     );
        //                 }
        //             },
