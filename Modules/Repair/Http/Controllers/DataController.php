...
class DataController extends Controller
{
    ...
    public function modifyAdminMenu()
    {
        ...
        // Define background color for demo environment
        $background_color = config('app.env') == 'demo' ? '#bc8f8f !important' : '#fdfdfd';
        ...
        if ($is_repair_enabled && (auth()->user()->can('superadmin') || auth()->user()->can('repair.view'))) {
            $menuItems[] = [
                ...
                'url' => action('\Modules\Repair\Http\Controllers\DashboardController@index'),
