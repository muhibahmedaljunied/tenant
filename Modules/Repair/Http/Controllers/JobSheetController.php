            ...
            return DataTables::of($job_sheets)
                ->addColumn('action', function ($row) {
                    ...
                    if (auth()->user()->can("job_sheet.view_assigned") || auth()->user()->can("job_sheet.view_all") || auth()->user()->can("job_sheet.create")) {
                        $html .= '<li>
                                <a href="' . action('\Modules\Repair\Http\Controllers\JobSheetController@show', $row->id) . '" class="cursor-pointer">
                                    <i class="fa fa-eye"></i>
                                    ' . __("messages.view") . '
                                </a>
                                </li>
                                <li>
                                <a href="' . action('\Modules\Repair\Http\Controllers\JobSheetController@print_slim', $row->id) . '" class="cursor-pointer">
                    ...
                    if (auth()->user()->can("job_sheet.edit")) {
                        $html .= '<li>
                                    <a href="' . action('\Modules\Repair\Http\Controllers\JobSheetController@edit', $row->id) . '" class="cursor-pointer edit_job_sheet">
...
*/
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (is_null($repair_settings)) {
                return redirect()->back()
                    ->with('status', [
                        'success' => false,
                        'msg' => __("repair::lang.must_set_settings_first")
                    ]);
            }
