    ...
    @component('components.filters', ['title' => __('report.filters'), 'closed' => false])
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select name="repair_status_id" id="repair_status_id" class="form-control select2" style="width:100%">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select name="service_staff_id" id="service_staff_id" class="form-control select2" style="width:100%">
                    <option value="">{{ __('lang_v1.all') }}</option>
