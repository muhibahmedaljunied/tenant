				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" name="shipping_charges" id="shipping_charges" class="form-control input_number" value="{{ @num_format($transaction->shipping_charges) }}" placeholder="{{ __('sale.shipping_charges') }}">
						</div>
					</div>
				</div>
