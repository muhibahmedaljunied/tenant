       ...
       <div class="col-sm-3">
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				<input type="text" name="module_info[repair][repair_status_label]" id="module_info[repair][repair_status_label]" value="{{ $default['repair_status_label'] }}" class="form-control" placeholder="{{ __('repair::lang.repair_status_label') }}">
			</div>
		</div>
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				<input type="text" name="module_info[repair][repair_warranty_label]" id="module_info[repair][repair_warranty_label]" value="{{ $default['repair_warranty_label'] }}" class="form-control" placeholder="{{ __('repair::lang.repair_warranty_label') }}">
			</div>
		</div>
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				<input type="text" name="module_info[repair][brand_label]" id="module_info[repair][brand_label]" value="{{ $default['brand_label'] }}" class="form-control" placeholder="{{ __('repair::lang.brand_label') }}">
			</div>
		</div>
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				<input type="text" name="module_info[repair][device_label]" id="module_info[repair][device_label]" value="{{ $default['device_label'] }}" class="form-control" placeholder="{{ __('repair::lang.device_label') }}">
			</div>
		</div>
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				<input type="text" name="module_info[repair][model_no_label]" id="module_info[repair][model_no_label]" value="{{ $default['model_no_label'] }}" class="form-control" placeholder="{{ __('repair::lang.model_no_label') }}">
			</div>
		</div>
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				<input type="text" name="module_info[repair][serial_no_label]" id="module_info[repair][serial_no_label]" value="{{ $default['serial_no_label'] }}" class="form-control" placeholder="{{ __('repair::lang.serial_no_label') }}">
			</div>
		</div>
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				<input type="text" name="module_info[repair][defects_label]" id="module_info[repair][defects_label]" value="{{ $default['defects_label'] }}" class="form-control" placeholder="{{ __('repair::lang.defects_label') }}">
			</div>
		</div>
		...
		<div class="col-sm-3">
			<div class="form-group">
				...
				<input type="text" name="module_info[repair][repair_checklist_label]" id="module_info[repair][repair_checklist_label]" value="{{ $default['repair_checklist_label'] }}" class="form-control" placeholder="{{ __('repair::lang.repair_checklist_label') }}">
			</div>
		</div>
    @endcomponent
@endif