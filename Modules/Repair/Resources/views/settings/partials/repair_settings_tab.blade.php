...
<div class="row">    
    ...
    <div class="col-sm-3">
        <div class="form-group">
            ...
            <input type="text" name="job_sheet_prefix" id="job_sheet_prefix" class="form-control" placeholder="{{ __('repair::lang.job_sheet_prefix') }}" value="{{ !empty($repair_settings['job_sheet_prefix']) ? $repair_settings['job_sheet_prefix'] : '' }}">
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-4">
        <div class="form-group">
            <label for="product_configuration">{{ __('repair::lang.product_configuration') . ':' }}</label>
            @show_tooltip(__('repair::lang.product_configuration_tooltip'))
            <textarea name="product_configuration" id="product_configuration" class="form-control" rows="4">{{ !empty($repair_settings['product_configuration']) ? $repair_settings['product_configuration'] : '' }}</textarea>
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="problem_reported_by_customer">{{ __('repair::lang.problem_reported_by_customer') . ':' }}</label>
            @show_tooltip(__('repair::lang.problem_reported_by_customer_tooltip'))
            <textarea name="problem_reported_by_customer" id="problem_reported_by_customer" class="form-control" rows="4">{{ !empty($repair_settings['problem_reported_by_customer']) ? $repair_settings['problem_reported_by_customer'] : '' }}</textarea>
        </div>
    </div>
    <div class="col-md-4">
        <div class="form-group">
            <label for="product_condition">{{ __('repair::lang.condition_of_product') . ':' }}</label>
            @show_tooltip(__('repair::lang.product_condition_tooltip'))
            <textarea name="product_condition" id="product_condition" class="form-control" rows="4">{{ !empty($repair_settings['product_condition']) ? $repair_settings['product_condition'] : '' }}</textarea>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <textarea name="repair_tc_condition" id="repair_tc_condition" class="form-control">{{ !empty($repair_settings['repair_tc_condition']) ? $repair_settings['repair_tc_condition'] : '' }}</textarea>
        </div>
    </div>
</div>
<div class="row">
