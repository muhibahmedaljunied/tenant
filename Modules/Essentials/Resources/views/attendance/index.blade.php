                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane @if(!$is_admin) active @endif" id="attendance_tab">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="date_range">{{ __('report.date_range') . ':' }}</label>
                                    <input type="text" name="date_range" id="date_range" placeholder="{{ __('lang_v1.select_a_date_range') }}" class="form-control" readonly>
                                </div>
                            </div>
                            @if($is_admin)
