...
<section class="content">
	@component('components.filters', ['title' => __('report.filters'), 'class' => 'box-solid'])
		@can('essentials.assign_todos')
			<div class="col-md-3">
				<div class="form-group">
					<label for="user_id_filter">{{ __('essentials::lang.assigned_to') . ':' }}</label>
		...
		<div class="col-md-3">
			<div class="form-group">
				<label for="priority_filter">{{ __('essentials::lang.priority') . ':' }}</label>
		...
		<div class="col-md-3">
			<div class="form-group">
				<label for="status_filter">{{ __('sale.status') . ':' }}</label>
		...
		<div class="col-md-3">
            <div class="form-group">
                <label for="date_range_filter">{{ __('report.date_range') . ':' }}</label>
                <input type="text" name="date_range_filter" id="date_range_filter" placeholder="{{ __('lang_v1.select_a_date_range') }}" class="form-control" readonly>
            </div>
        </div>
	@endcomponent
