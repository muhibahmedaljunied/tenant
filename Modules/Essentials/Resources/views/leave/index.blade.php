...
<section class="content">
    <div class="row">
        ...
        @component('components.filters', ['title' => __('report.filters'), 'class' => 'box-solid'])
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="leave_type_filter">{{ __('essentials::lang.leave_type') . ':' }}</label>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="leave_filter_date_range">{{ __('report.date_range') . ':' }}</label>
                    <input type="text" name="leave_filter_date_range" id="leave_filter_date_range" placeholder="{{ __('lang_v1.select_a_date_range') }}" class="form-control" readonly value="{{ old('leave_filter_date_range') }}">
                </div>
            </div>
        @endcomponent
        </div>
