	...
	<h4>
		...
		<div class="box box-solid">
			...
			<div class="box-body">
				<div class="row">
					<div class="col-md-12">
						<form action="{{ action('\\Modules\\Essentials\\Http\\Controllers\\DocumentController@store') }}" id="upload_document_form" enctype="multipart/form-data" style="display:none" method="post">
    @csrf
    <div class="row">
        <div class="col-sm-12">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="name">{{ __('essentials::lang.heading') . ':*' }}</label>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="description">{{ __('essentials::lang.description') . ':' }}</label>
