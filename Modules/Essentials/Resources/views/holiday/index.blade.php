...
<section class="content">
    <div class="row">
        ...
        @component('components.filters', ['title' => __('report.filters'), 'class' => 'box-solid'])
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label for="holiday_filter_date_range">{{ __('report.date_range') . ':' }}</label>
                    <input type="text" name="holiday_filter_date_range" id="holiday_filter_date_range" placeholder="{{ __('lang_v1.select_a_date_range') }}" class="form-control" readonly value="{{ old('holiday_filter_date_range') }}">
                </div>
            </div>
        @endcomponent
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.widget', ['class' => 'box-solid', 'title' => __( 'essentials::lang.all_holidays' )])
                ...
                @slot('tool')
                    <div class="box-tools">
                        <button type="button" class="btn btn-block btn-primary btn-modal" data-href="{{route('essentialsHoliday-create')}}" data-container="#add_holiday_modal">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            holidays_table = $('#holidays_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    "url": "{{route('essentialsHoliday-index')}}",
                    "data" : function(d) {
