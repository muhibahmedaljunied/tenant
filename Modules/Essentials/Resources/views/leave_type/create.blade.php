	    ...
	    <form action="{{ action('\\Modules\\Essentials\\Http\\Controllers\\EssentialsLeaveTypeController@store') }}" method="post" id="add_leave_type_form">
		    ...
		    <div class="modal-body">
		      	<div class="form-group">
		            ...
		            <input type="text" name="leave_type" id="leave_type" class="form-control" required placeholder="{{ __( 'essentials::lang.leave_type' ) }}" value="{{ old('leave_type') }}">
		      	</div>

		      	<div class="form-group">
		        	<label for="max_leave_count">{{ __( 'essentials::lang.max_leave_count' ) . ':' }}</label>
		            <input type="number" name="max_leave_count" id="max_leave_count" class="form-control" placeholder="{{ __( 'essentials::lang.max_leave_count' ) }}" value="{{ old('max_leave_count') }}">
		      	</div>
