                                ...
                                <div class="col-sm-12">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="name">{{ __('essentials::lang.document') . ':*' }}</label>
                                            <input type="file" name="name" id="name" required accept="{{ implode(',', array_keys(config('constants.document_upload_mimes_types'))) }}">
                                            <p class="help-block">
