...
<form action="{{ action('\\Modules\\Essentials\\Http\\Controllers\\PayrollController@update', [$payroll->id]) }}" method="post" id="add_payroll_form">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-12">
            @component('components.widget')
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="essentials_duration">{{ __( 'essentials::lang.total_work_duration' ) . ':*' }}</label>
                        <input type="text" name="essentials_duration" id="essentials_duration" class="form-control input_number" placeholder="{{ __( 'essentials::lang.total_work_duration' ) }}" value="{{ $payroll->essentials_duration }}" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="essentials_duration_unit">{{ __( 'essentials::lang.duration_unit' ) . ':' }}</label>
                        <input type="text" name="essentials_duration_unit" id="essentials_duration_unit" class="form-control" placeholder="{{ __( 'essentials::lang.duration_unit' ) }}" value="{{ $payroll->essentials_duration_unit }}">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="essentials_amount_per_unit_duration">{{ __( 'essentials::lang.amount_per_unit_duartion' ) . ':*' }}</label>
                        <input type="text" name="essentials_amount_per_unit_duration" id="essentials_amount_per_unit_duration" class="form-control input_number" placeholder="{{ __( 'essentials::lang.amount_per_unit_duartion' ) }}" value="{{ @num_format($payroll->essentials_amount_per_unit_duration) }}" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="total">{{ __( 'sale.total' ) . ':' }}</label>
                        <input type="text" name="total" id="total" class="form-control input_number" placeholder="{{ __( 'sale.total' ) }}" value="{{ @num_format($payroll->essentials_duration * $payroll->essentials_amount_per_unit_duration) }}">
                    </div>
                </div>
            @endcomponent
        </div>
        <div class="col-md-12">
            ...
            <div class="col-md-12">
                ...
                <input type="hidden" name="final_total" id="gross_amount" value="{{ $payroll->final_total }}"><br>
            </div>
