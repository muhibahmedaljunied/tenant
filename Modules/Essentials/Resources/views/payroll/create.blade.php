            ...
            @component('components.widget')
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" name="essentials_duration" id="essentials_duration" class="form-control input_number" placeholder="{{ __( 'essentials::lang.total_work_duration' ) }}" value="{{ $total_work_duration }}" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="essentials_duration_unit">{{ __( 'essentials::lang.duration_unit' ) . ':' }}</label>
                        <input type="text" name="essentials_duration_unit" id="essentials_duration_unit" class="form-control" placeholder="{{ __( 'essentials::lang.duration_unit' ) }}" value="Hour">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="essentials_amount_per_unit_duration">{{ __( 'essentials::lang.amount_per_unit_duartion' ) . ':*' }}</label>
                        <input type="text" name="essentials_amount_per_unit_duration" id="essentials_amount_per_unit_duration" class="form-control input_number" placeholder="{{ __( 'essentials::lang.amount_per_unit_duartion' ) }}" value="0" required>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="total">{{ __( 'sale.total' ) . ':' }}</label>
                        <input type="text" name="total" id="total" class="form-control input_number" placeholder="{{ __( 'sale.total' ) }}" value="0">
                    </div>
                </div>
            @endcomponent
            </div>
