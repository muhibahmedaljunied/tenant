  	...
  	<div class="user-block">
        <span class="username" style="margin-left: 0;">
          ...
          @if($message->user_id == auth()->user()->id)
          	<a href="{{route('essentialsMessage-destroy', [$message->id])}}" class="pull-right btn-box-tool chat-delete" title="@lang('messages.delete')"><i class="fa fa-times text-danger"></i></a>
          @endif
        </span>
