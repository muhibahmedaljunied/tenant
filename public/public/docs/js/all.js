!(function () {
    if ('ontouchstart' in window) {
        ...
        (e = function (e, t) {
            ...
            (r = function (t) {
                if (
                    !this.threshold &&
                    !e(this.startXY, [t.changedTouches[0].clientX, t.changedTouches[0].clientY])
                ) {
            ...
            (i = function (e) {
                ...
                return (
                    ...
                    (s.x = r),
                    (s.y = i),
                    ((!e.simulated && (500 > n || (1500 > n && a[0] < 50 && a[1] < 50))) || d) &&
    ...
    !(function (e, t) {
        ...
        function f(e, t) {
            return G.nodeName(e, 'table') && G.nodeName(11 !== t.nodeType ? t : t.firstChild, 'tr')
        ...
        function w(e) {
            ...
            return (
                n ||
                    ((n = b(e, t)),
                    ('none' !== n && n) ||
                        ((Ie = (Ie || G("<iframe frameborder='0' width='0' height='0'/>")).appendTo(
                            t.documentElement
                        )),
                ...
                'margin' === n && (s += G.css(e, n + _e[o], !0, i)),
                    r
                        ? ('content' === n && (s -= G.css(e, 'padding' + _e[o], !0, i)),
                          'margin' !== n && (s -= G.css(e, 'border' + _e[o] + 'Width', !0, i)))
                        : ((s += G.css(e, 'padding' + _e[o], !0, i)),
                          'padding' !== n && (s += G.css(e, 'border' + _e[o] + 'Width', !0, i)));
            return s;
        }
        function E(e, t, n) {
            var r = !0,
            ...
            if (0 >= i || null == i) {
                if (((i = x(e, t, o)), (0 > i || null == i) && (i = e.style[t]), Pe.test(i)))
                    return i;
        ...
        function M(e, t, n) {
            ...
            n.queue ||
                ...
                1 === e.nodeType &&
                    ...
                    'inline' === u && 'none' === G.css(e, 'float') && (p.display = 'inline-block')),
                n.overflow &&
                    ((p.overflow = 'hidden'),
                    d.always(function () {
            ...
            (x = t.support = {}),
                ...
                (t.uniqueSort = function (e) {
                    var t,
                        ...
                        i = 0;
                    if (
                        ((L = !x.detectDuplicates), (A = !x.sortStable && e.slice(0)), e.sort(Q), L)
                    ) {
        ...
        (G.filter = function (e, t, n) {
            ...
            G.fn.extend({
                ...
                is: function (e) {
                    return !!r(this, 'string' == typeof e && oe.test(e) ? G(e) : e || [], !1)
                        .length;
                },
            });
        var ce,
                ...
                closest: function (e, t) {
                    for (
                        var n,
                            ...
                            i = this.length,
                            o = [],
                            s = oe.test(e) || 'string' != typeof e ? G(e, t || this.context) : 0;
                        i > r;
                        r++
                    )
                ...
                function (e, t) {
                    G.fn[e] = function (n, r) {
                        ...
                        return (
                            ...
                            this.length > 1 && (fe[e] || G.unique(i), de.test(e) && i.reverse()),
                            this.pushStack(i)
                        );
                    };
                }
            ...
            (a.prototype = {
                ...
                access: function (e, t, n) {
                    ...
                    return void 0 === t || (t && 'string' == typeof t && void 0 === n)
                        ? ((r = this.get(e, t)), void 0 !== r ? r : this.get(e, G.camelCase(t)))
        ...
        var xe = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            ...
            ke = function (e, t) {
                return (
                    (e = t || e), 'none' === G.css(e, 'display') || !G.contains(e.ownerDocument, e)
                );
            },
            Ce = /^(?:checkbox|radio)$/i;
        !(function () {
        ...
        (G.event = {
                    ...
                    for (o = 0; (s = f[o++]) && !t.isPropagationStopped(); )
                        (t.type = o > 1 ? c : d.bindType || p),
                            ...
                            u &&
                                u.apply &&
                                G.acceptData(s) &&
                                ((t.result = u.apply(s, n)), t.result === !1 && t.preventDefault());
                    return (
                        (t.type = p),
                        i ||
            ...
            special: {
                ...
                click: {
                    trigger: function () {
                        return 'checkbox' === this.type && this.click && G.nodeName(this, 'input')
                            ? (this.click(), !1)
                            : void 0;
                    },
                    _default: function (e) {
                    ...
                    if (
                        ...
                        for (i = G.map(v(n, 'script'), p), o = i.length; l > c; c++)
                            (s = n),
                                ...
                                t.call(this[c], s, c);
                        if (o)
                            for (a = i[i.length - 1].ownerDocument, G.map(i, h), c = 0; o > c; c++)
                                (s = i[c]),
                                    Oe.test(s.type || '') &&
                ...
                attr: function (e, t, n) {
                    ...
                    return e && 3 !== o && 8 !== o && 2 !== o
                        ? typeof e.getAttribute === Ne
                            ...
                            : ((1 === o && G.isXMLDoc(e)) ||
                                  ((t = t.toLowerCase()),
                                  (r = G.attrHooks[t] || (G.expr.match.bool.test(t) ? it : rt))),
                              void 0 === n
                    ...
                    ? ((r = G.isFunction(e)),
                      this.each(function (n) {
                          ...
                          1 === this.nodeType &&
                              ...
                              (t =
                                  G.valHooks[this.type] || G.valHooks[this.nodeName.toLowerCase()]),
                    ...
                    select: {
                        ...
                        set: function (e, t) {
                            for (var n, r, i = e.options, o = G.makeArray(t), s = i.length; s--; )
                                (r = i[s]), (r.selected = G.inArray(r.value, o) >= 0) && (n = !0);
        ...
        G.ajaxSetup({
            ...
            G.ajaxPrefilter('json jsonp', function (t, n, r) {
                ...
                return a || 'jsonp' === t.dataTypes[0]
                    ? ((i = t.jsonpCallback =
                          G.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
                      a
    ...
    !(function (e) {
        ...
        function u(e, n, i, o) {
            ...
            function g() {
                ...
                return (
                    C.r > 0 && (T += n.r), e && (N[C.sL] = n.top), p(n.language, n.value, !1, !0)
                );
            }
            function m() {
        ...
        function h(e) {
            ...
            if (!i(t)) {
                ...
                (s.value = f(s.value)),
                    ...
                    s.second_best &&
                        (e.second_best = { language: s.second_best.language, re: s.second_best.r });
            }
        }
        function g(e) {
            x = s(x, e);
                ...
                return {
                    ...
                    c: [
                        ...
                        { b: /(::|->)+[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*/ },
                        {
                            ...
                            c: [
                                e.UTM,
                                { cN: 'params', b: '\\(', e: '\\)', c: ['self', t, e.CBCM, r, i] },
                            ],
                        },
                        {
                            cN: 'class',
            ...
            (e.Widget.prototype = {
                ...
                _trigger: function (t, n, r) {
                    ...
                    return (
                        ...
                        !(
                            (e.isFunction(s) && s.apply(this.element[0], [n].concat(r)) === !1) ||
        ...
        (e.version = '0.5.7'),
            ...
            (e.Index.prototype.idf = function (e) {
                ...
                var n = this.tokenStore.count(e),
                    r = 1;
                return (
                    n > 0 && (r = 1 + Math.log(this.tokenStore.length / n)), (this._idfCache[t] = r)
                );
            }),
            ...
            (e.Index.prototype.documentVector = function (t) {
                for (
                    var n = this.documentStore.get(t), r = n.length, i = new e.Vector(), o = 0;
                    r > o;
                    o++
                ) {
                    var s = n.elements[o],
