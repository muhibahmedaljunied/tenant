$(document).ready(function () {
    ...
    purchase_table = $('#purchase_table').DataTable({
        ...
        ajax: {
            url: '/purchases',
            data: function (d) {
                console.log('hebo_habebe', d);
                if ($('#purchase_list_filter_location_id').length) {
                    d.location_id = $('#purchase_list_filter_location_id').val();
                }
                if ($('#purchase_list_filter_store_id').length) {
                    d.store_id = $('#purchase_list_filter_store_id').val();
                }
    ...
    $(document).on(
        ...
        '#purchase_list_filter_location_id, \
                    #purchase_list_filter_store_id,#purchase_list_filter_supplier_id, #purchase_list_filter_payment_status,\
