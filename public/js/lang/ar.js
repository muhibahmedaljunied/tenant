LANG = {
    ...
    'sku_must_unique': 'الكود SKU يجب ان يكون مختلف.',
    'unit_must_unique': 'الوحده يجب ان تكون مختلفه .',
    ...
    'confirm_delete_journal_entry': 'سيتم حذف  قيد اليومية هذا  . ',
    'confirm_delete_cost_center': 'سيتم حذف  مركز التكلفة  هذا  . ',
    'confirm_delete_record': 'سيتم حذف   السجل  هذا  . ',
    'prev': 'السابق',
    'next': 'التالى',
    ...
    'unit_must_unique' : 'يجب أن تكون الوحدة فريده',
};